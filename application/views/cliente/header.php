...
<div id="header">
		<ul class="nav">
            <li class="logo"><a href="https://exeleventos.com" target="_blank"><img src="<?php echo base_url() ?>img/logo_intranet.png" width="60" height="auto" /></a></li>
			<!--<li><a href="<?php echo base_url() ?>cliente/topSongs">C2</a></li>-->
