...
<div class="header">
 ...
 <h2 style="color:#93CE37!important;">Login</h2>
<div class="main">
  ...
  <div style="margin:0 auto; text-align:center; width:400px; padding:20px">
    <form method="post" style="width:300px">
      <fieldset style="width:300px">
        ...
        <input style="float: left; margin:0 0 2px 0" type="password" name="pass" value="" />
        <br style="clear:both" />
        ...
        <div style="text-align:center; padding-top:5px"> <font style="font-size:smaller; color:#F00">
          ...
          <div style="padding-top:5px"> <font style="font-size:smaller;">
