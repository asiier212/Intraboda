        	...
        	<legend>Mis servicios contratados</legend>
             ...
             <table class="tabledata">
                ...
                if($cliente['descuento']<>0){
					?>
                    <tr>
                        <td><b>Subtotal</b></td><td style="text-align:right;"><b><?php echo number_format($total,2,',','.')?> &euro;</b></td>
                    </tr>
                    <?php
				}
				if($cliente['descuento']<>0){
				?>
                    <tr>
                        <td>Descuento adicional aplicado</td><td style="text-align:right;"><?php echo number_format($cliente['descuento'],2,',','.')?> &euro;</td>
                    </tr>
                    <?php
				}
				?>
                <tr>
                	<td><b>Total del contrato</b></td><td style="text-align:right;"><b><?php echo number_format(($total -  $cliente['descuento']),2,',','.')?> &euro;</b></td>
                </tr>
           </table>
