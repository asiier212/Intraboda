...
$(function() {
	$('#artista').keypress(function(e){
        ...
        var fullurl = $('#hiddenurl').val() + 'index.php/ajax/buscarartista/' + searched;
	 ...
	 $('#nombre').keypress(function(e){
        ...
        var fullurl = $('#hiddenurl').val() + 'index.php/ajax/buscarcanciones/' + searched + '/' + artist;
...
<div class="main">
    ...
    <fieldset class="datos">
        ...
        <ul>
            ...
            <input type="submit" style="width:100px; margin-left:10px" name="add_song" value="A&ntilde;adir" /></li>
