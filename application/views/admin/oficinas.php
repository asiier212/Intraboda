	...
	<fieldset class="datos">
    	<legend>Nueva oficina</legend>
		   <ul>
                ...
                <li><label>(*)Web:</label><input type="text" name="web" id="web_nuevo" style="width:200px" /> <font size="-2">(Con http://)</font> </li>
        ...
        <legend>Listado Oficinas</legend>
		   <ul>
                ...
                <table>
                	...
                	<td>
						<?php if($ofi['logo_mail'] != '') {?>
                            <img src="<?php echo base_url() ?>uploads/oficinas/<?php echo $ofi['logo_mail']?>" align="absmiddle" width="239" />
                        <?php }?>
                    </td>
                    </tr>
                    <tr>
                    <td> 
                		Dirección: <?php echo $ofi['direccion']?>
                    </td>
                    </tr>
                    <tr>
                    <td> 
                		Población: <?php echo $ofi['poblacion']?>
                    </td>
                    </tr>
                    <tr>
                    <td> 
                    ...
                    <tr>
                    <td> 
                		Teléfono: <?php echo $ofi['telefono']?>
                    </td>
                    </tr>
                    <tr>
                    <td> 
                		Móvil: <?php echo $ofi['movil']?>
                    </td>
                    </tr>
                    <tr>
                    <td> 
                		Fax: <?php echo $ofi['fax']?>
                    </td>
                    </tr>
                    <tr>
                    <td>
                		E-mail: <?php echo $ofi['email']?>
                    </td>
                    </tr>
                    <tr>
                    <td>
                		Web: <?php echo $ofi['web']?>
                    </td>
                    </tr>
                    <tr>
                    <td>
                		<input style="width:60px;" type="submit" value="Borrar" name="delete" onclick="return del(<?php echo $ofi['id_oficina']?>)" />
                        <input style="width:60px;" type="button" value="Editar" onclick="edit(<?php echo $ofi['id_oficina']?>)" />
                    </td>
                    </tr>
                </table>
                </li>
                <li style="border-bottom:#CCC 1px solid; width:850px; display:none" id="edit<?php echo $ofi['id_oficina']?>">
               	<?php if($ofi['logo_mail'] != '') {?>
                	<img src="<?php echo base_url() ?>uploads/oficinas/<?php echo $ofi['logo_mail']?>" width="286" align="absmiddle" />
                <?php }?><br /><br />
               ...
               <input type="text" id="cp<?php echo $ofi['id_oficina']?>" value="<?php echo $ofi['cp']?>" />
                <input type="text" id="telefono<?php echo $ofi['id_oficina']?>" value="<?php echo $ofi['telefono']?>" style="width:80px" />
               ...
               <input type="text" id="email<?php echo $ofi['id_oficina']?>" value="<?php echo $ofi['email']?>" style="width:120px"/>
               <input type="text" id="web<?php echo $ofi['id_oficina']?>" value="<?php echo $ofi['web']?>" style="width:120px"/>
                <input style="width:80px;" type="button" value="Cancelar" onclick="cancel(<?php echo $ofi['id_oficina']?>)" /><input style="width:60px;" type="button" id="guardar" value="Guardar" onclick="save(<?php echo $ofi['id_oficina']?>)" />
                </li>
                </fieldset>
              <?php }
				}?>
