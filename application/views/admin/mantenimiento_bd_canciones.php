	...
	<fieldset class="datos">
    	<legend>Canciones</legend>
        	<ul>
				...
				?>
                	<input type="hidden" name="validada" id="validada" value="<?php echo $validada?>" /></li>
                <li><input type="submit" value="Filtrar" /></li>
            </ul>
            
            <br><br>
       		
            <div id="canciones" style="padding-left:150px;text-align:center;">
			...
			if($bd_canciones[0]['id']<>"") //COMPRUEBO QUE EL RESULTADO NO SEA VACIO PARA QUE NO ME DE ERROR FOREACH
			{
				...
				foreach($bd_canciones as $cancion){
						?>
						<tr>
						<td><li style="list-style: none;" id="can_<?php echo $cancion['id']?>"><span style="font-size:16px" class="edit_box_artista" id="<?php echo $cancion['id']?>"><?php echo $cancion['artista']?></span></li>
						</td>
						
						<td><li style="list-style: none;" id="can_<?php echo $cancion['id']?>"><span style="font-size:16px" class="edit_box_cancion" id="<?php echo $cancion['id']?>"><?php echo $cancion['cancion']?></span></li></td>
