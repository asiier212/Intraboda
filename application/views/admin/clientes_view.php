  ...
  function confirmar() {
	...
	<fieldset class="datos">
    	<legend>Clientes</legend>
            ...
            Buscador por: &nbsp;
            <select name="f">
            	<option value="clientes.nombre_novia" <?php if(isset($_GET['f']) && $_GET['f'] == 'nombre_novia') echo 'selected="selected"'?>>Nombre novia</option>
                <option value="clientes.nombre_novio" <?php if(isset($_GET['f']) && $_GET['f'] == 'nombre_novio') echo 'selected="selected"'?>>Nombre novio</option>
                <option value="clientes.apellidos_novia" <?php if(isset($_GET['f']) && $_GET['f'] == 'apellidos_novia') echo 'selected="selected"'?>>Apellidos novia</option>
                <option value="clientes.apellidos_novio" <?php if(isset($_GET['f']) && $_GET['f'] == 'apellidos_novio') echo 'selected="selected"'?>>Apellidos novio</option>
                <option value="clientes.poblacion_novia" <?php if(isset($_GET['f']) && $_GET['f'] == 'poblacion_novia') echo 'selected="selected"'?>>Poblacion novia</option>
                <option value="clientes.poblacion_novio" <?php if(isset($_GET['f']) && $_GET['f'] == 'poblacion_novio') echo 'selected="selected"'?>>Poblacion novio</option>
                <option value="clientes.telefono_novia" <?php if(isset($_GET['f']) && $_GET['f'] == 'telefono_novia') echo 'selected="selected"'?>>Telefono novia</option>
                <option value="clientes.telefono_novio" <?php if(isset($_GET['f']) && $_GET['f'] == 'telefono_novio') echo 'selected="selected"'?>>Telefono novio</option>
        ...
        <?php if($clientes) {
		   ...
		   <table class="tabledata">
           		<tr>
                    ...
                    <th><a style="color:#FFF; text-decoration:underline" href="<?php echo $url_ord ?>feacha">Fecha Alta</a></th>
