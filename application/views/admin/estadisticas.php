...
<form method="post">
	<fieldset class="datos">
    	<legend>Estadísticas</legend>
            ...
            <tr><th colspan="2">Servicios contratados entre <?php echo $fecha_desde?> y <?php echo $fecha_hasta?></th></tr>
            <th>Servicio</th>
            <th>Veces</th>
			<?php
            ...
            <table class="tabledata">
            <tr><th colspan="2">Canales de captación entre <?php echo $fecha_desde?> y <?php echo $fecha_hasta?></th></tr>
            <th>Canal</th>
            <th>Veces</th>
			<?php
            ...
            <tr><th colspan="<?php echo $comerciales[0]['num_estados']+2?>">Comerciales entre <?php echo $fecha_desde?> y <?php echo $fecha_hasta?></th></tr>
            <th>Comercial</th>
            <th>Nº Presup.</th>
            <?php
			foreach($estados_solicitudes as $estado)
            {
				?><th><?php echo $estado['nombre_estado']?></th><?php
			}
			?>
			<?php
            foreach($comerciales as $com)
            {
				...
				foreach($estados_solicitudes as $estado)
            	{
					...
					echo $com[$estado['nombre_estado'].'p']?>%</td><?php
				}
				?>
                </tr>
                <?php
