			...
			<fieldset class="datos">
				...
				<ul>
					...
					<li><label>Hora de la boda:</label>
						<span class="edit_box" id="hora_boda"><?php echo $solicitud['hora_boda'] ?></span>
					</li>
			...
			if ($solicitud['estado_solicitud'] <> 2 && $solicitud['estado_solicitud'] <> 5 && $solicitud['estado_solicitud'] <> 8) {
				...
				<ul>
					...
					<li><label>(*)Próxima llamada:</label>
						<input type="text" id="fecha_prox_llamada" name="fecha_prox_llamada" required value="<?php echo $nueva_llamada ?>">
					</li>
